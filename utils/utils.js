...
exports.toDecimal = (num, places = 2) => Number(num.toFixed(places));

// Grouping objects from object list by their 'type' or any other key, returns an object
exports.groupObjects = (objectsList, key = "type") =>
